...
Возвращаемое значение:
 - Строка - информация об очереди в формате объекта json. Пример: `{"name": "my-queue", "messageCount": 10, "consumerCount": 0}`, где: 
    * name - Имя очереди, заданное явно в 1-м параметре
    * messageCount - Количество сообщений в очереди
    * consumerCount - Количество подключенных к очереди потребителей сообщений.
