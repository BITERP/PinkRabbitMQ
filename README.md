...
``` bsl
УстановитьВнешнююКомпоненту("ОбщийМакет.адаптер_NativeRabbitMQ");
ПодключитьВнешнююКомпоненту("ОбщийМакет.NativeRabbitMQ", "BITERP", ТипВнешнейКомпоненты.Native);
...
УстановитьВнешнююКомпоненту("ОбщийМакет.адаптер_NativeRabbitMQ");
ПодключитьВнешнююКомпоненту("ОбщийМакет.адаптер_NativeRabbitMQ", "BITERP", ТипВнешнейКомпоненты.Native);
Клиент  = Новый("AddIn.BITERP.NativeRabbitMQ");
